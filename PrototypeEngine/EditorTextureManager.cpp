...
Texture* EditorTextureManager::GetFileExtensionTexture(
    const std::string& extension) const
{
    ...
    {
        texture = mExtensionTextureMap.at(
            extension); // 例として、拡張子に対応するテクスチャをマップから取得
    }
    else
    {
...
Texture* EditorTextureManager::GetFileIconTexture(const std::string& filePath,
