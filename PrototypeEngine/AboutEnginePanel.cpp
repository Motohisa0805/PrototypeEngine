...
void AboutEnginePanel::Draw(float width, float height)
{
	...
	if (ImGui::Begin(GetImGuiWindowID().c_str(), &mIsShow, flags)) {
		...
		ImGui::TextLinkOpenURL("GitHub URL","https://github.com/Motohisa0805/PrototypeEngine");
		...
		if (ImGui::TreeNode("Dear ImGui")) {
			...
			ImGui::TextLinkOpenURL("Dear ImGui GitHub URL", "https://github.com/ocornut/imgui");
			ImGui::TreePop();
		}
		if (ImGui::TreeNode("SDL3 (Simple DirectMedia Layer)")) {
			...
			ImGui::TextLinkOpenURL("SDL3 Official Page URL", "https://wiki.libsdl.org/SDL3/FrontPage");
			ImGui::TreePop();
		}
		if (ImGui::TreeNode("<OpenGL / GLEW>2.2.0")) {
			...
			ImGui::TextLinkOpenURL("OpenGL Official Page URL", "https://www.opengl.org/");
			ImGui::TreePop();
		}
