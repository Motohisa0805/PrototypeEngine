...
void HierarchyExplanationPanel::Initialize(float width, float height,
                                           ImTextureRef ref)
{
...
void HierarchyExplanationPanel::Draw(float width, float height)
{
    ...
    if (ImGui::Begin(GetImGuiWindowID().c_str(), &mIsShow, flags))
    {
        ...
        ImGui::Text(
            "You can select an actor and perform various clipboard operations "
            "from the menu that appears when you right-click.");
        ImGui::Text("or");
        ...
        ImGui::SetWindowFontScale(1.0f);
        ImGui::Text(
            "Right click to display the menu and select [Create Empty Actor]");
        ImGui::Text("or");
        ImGui::Text(
            "Select [Create Empty Actor] within the GameObject on the taskbar");
        ...
        ImGui::SetWindowFontScale(1.0f);
        ImGui::Text(
            "Right click to display the menu and select [Create Empty Canvas]");
        ImGui::Text("or");
        ImGui::Text("Select [Create Empty Canvas] within the GameObject on the "
                    "taskbar");
        ...
        ImGui::SetWindowFontScale(1.0f);
        ImGui::Text("Right click to display the menu and select [Create Empty "
                    "UIActor]");
        ImGui::Text("or");
        ImGui::Text("Select [Create Empty UIActor] within the GameObject on "
                    "the taskbar");
    }
    ImGui::End();
}
