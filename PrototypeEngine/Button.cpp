...
Button::Button(const char8_t* name, Font* font, std::function<void()> onClick,
const Vector2& pos, const Vector2& dims) : Image() , mOnClick(onClick) ,
mClickCount(0) , mFont(font) , mPosition(pos) , mDimensions(dims) ,
mHighlighted(false)
{
    mBaseButtonPosition = pos;
